...
export const metadata: Metadata = {
  ...
  description: 'Preview of our general contractor website template.',
};
  ...
  const faqs = [
    {
      ...
      answer: 'Yes, we offer free estimates for all projects. Contact us to schedule a consultation.',
    },
    {
    ...
    },
    {
      ...
      answer: 'We serve [Placeholder City] and surrounding areas within a 30-mile radius.',
    },
  ];
      ...
      <Section background="cloud" className="pt-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8">
            [Your Company Name] - Professional contracting services in [Your City]
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:555-123-4567"
              className="bg-orange-500 text-white font-semibold px-8 py-4 rounded-xl hover:bg-orange-600 transition-colors"
            >
              Call (555) 123-4567
            </a>
            <a
              href="#contact"
              className="border-2 border-sb-line hover:border-orange-500 text-sb-ink font-semibold px-8 py-4 rounded-xl transition-colors"
            >
              Get a Free Estimate
            </a>
          </div>
          ...
          {services.map((service, index) => (
            <Card key={index} className="rounded-2xl border-sb-line">
              <CardContent className="p-6">
                <Check className="h-8 w-8 text-orange-500 mb-3" />
      ...
      <Section background="cloud" id="contact">
        ...
        <Card className="max-w-2xl mx-auto rounded-3xl border-sb-line shadow-lg">
          <CardContent className="p-8">
            <LeadForm formName="contractor-template" />
          </CardContent>
        </Card>
      </Section>
    </>
