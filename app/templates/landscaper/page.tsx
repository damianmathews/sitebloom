...
export const metadata: Metadata = {
  title: 'Landscaper Template Preview',
  description: 'Preview of our landscaping services website template.',
};

export default function LandscaperTemplatePage() {
  const services = [
    'Landscape Design',
    'Lawn Maintenance',
    'Tree & Shrub Care',
  ...
  const faqs = [
    {
      ...
      answer: 'Yes, we offer free estimates for all landscaping projects. Contact us to schedule a consultation.',
    },
    {
      question: 'Do you offer maintenance plans?',
      answer: 'Yes! We offer weekly, bi-weekly, and monthly maintenance plans to keep your property looking beautiful year-round.',
    },
    {
      ...
      <Section background="cloud" className="pt-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8">
            [Your Company Name] - Professional landscaping services in [Your City]
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:555-123-4567"
              className="bg-green-500 text-white font-semibold px-8 py-4 rounded-xl hover:bg-green-600 transition-colors"
            >
              Call (555) 123-4567
            </a>
            <a
              href="#contact"
              className="border-2 border-sb-line hover:border-green-500 text-sb-ink font-semibold px-8 py-4 rounded-xl transition-colors"
            >
              Get a Free Estimate
            </a>
          </div>
      ...
      <Section background="cloud" id="contact">
        ...
        <Card className="max-w-2xl mx-auto rounded-3xl border-sb-line shadow-lg">
          <CardContent className="p-8">
            <LeadForm formName="landscaper-template" />
          </CardContent>
        </Card>
      </Section>
    </>
