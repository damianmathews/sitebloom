...
export const metadata: Metadata = {
  title: 'Roofer Template Preview',
  description: 'Preview of our roofing services website template.',
};

export default function RooferTemplatePage() {
  const services = [
    'Roof Installation',
    'Roof Repair',
    'Roof Inspection',
  ...
  const faqs = [
    {
      ...
      answer: 'Yes, we offer free estimates for all roofing projects. Contact us to schedule an inspection.',
    },
    {
      question: 'Do you offer emergency service?',
      answer: 'Yes! We provide 24/7 emergency roofing service for leaks and storm damage.',
    },
    {
  ...
  return (
    <>
      ...
      <Section background="cloud" className="pt-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8">
            [Your Company Name] - Expert roofing services in [Your City]
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:555-123-4567"
              className="bg-red-500 text-white font-semibold px-8 py-4 rounded-xl hover:bg-red-600 transition-colors"
            >
              Call (555) 123-4567
            </a>
            <a
              href="#contact"
              className="border-2 border-sb-line hover:border-red-500 text-sb-ink font-semibold px-8 py-4 rounded-xl transition-colors"
            >
          ...
          {services.map((service, index) => (
            <Card key={index} className="rounded-2xl border-sb-line">
              <CardContent className="p-6">
                <Check className="h-8 w-8 text-red-500 mb-3" />
      ...
      <Section background="cloud" id="contact">
        <SectionHeader headline="Get Your Free Inspection" />
        <Card className="max-w-2xl mx-auto rounded-3xl border-sb-line shadow-lg">
          <CardContent className="p-8">
            <LeadForm formName="roofer-template" />
          </CardContent>
        </Card>
      </Section>
    </>
